...
public class FedoraSecurityMonitor {
    ...
    private static final Map<Path, String> hashes =
            new ConcurrentHashMap<>();

    private static final Map<WatchKey, Path> watchKeys =
            new ConcurrentHashMap<>();

    private static final Path LOG =
            Paths.get("security-monitor.log");

    // Change these to the directories you want to monitor.
    private static final List<Path> MONITORED_DIRECTORIES =
            List.of(
